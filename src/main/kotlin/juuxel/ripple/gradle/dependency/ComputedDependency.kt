...
/**
 * Inspired by Chocohead's [`ComputedDependency`](https://github.com/Chocohead/Fabric-Loom/blob/e3d1762a/src/main/java/net/fabricmc/loom/dependencies/ComputedDependency.java).
 */
